...
function Contact() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-black py-32 px-6 overflow-hidden relative">
        {/* Background effects */}
        ...
        {/* Footer */}
        <p className="text-center absolute bottom-8 left-0 right-0 text-[#3d3d3d] text-sm font-outfit font-light tracking-wide z-10">
